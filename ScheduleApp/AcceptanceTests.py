...
class AcceptanceTests(TestCase):
    ...
    def test_editAccount(self):
        ...
        self.assertTrue((user3.permission[1] != 1 & user2.permission == 2), "Not Authorized To Use This Command")
    ...
    def test_deleteAccount(self):
        ...
        self.assertTrue(user2.permission == '2', "Not Authorized To Use This Command")
    ...
    def test_createCourse(self):
        ...
        self.assertTrue((user3.permission[1] != '1' and user2.permission[1] == '2'), "Not Authorized To Use This Command")
        ...
        self.user = user
        self.assertEqual(Terminal.createCourse(self, course.name, course.courseNumber, course.classNumber, course.time,
                                                course.location), "Course Has Been Created")

        self.assertEqual(Terminal.createCourse(self, course.name, course.courseNumber, course.classNumber, course.time,
                                               course.location), "Course Already Exists")

        self.assertEqual(Terminal.createCourse(self, 'sdfs)gfsfw:::::', course.courseNumber, course.classNumber, course.time,
                                               course.location), "Invalid name")

        self.assertEqual(Terminal.createCourse(self, course.name, 'sdkjfbdf', course.classNumber, course.time,
                                               course.location), "Invalid Course Number")

        self.assertEqual(Terminal.createCourse(self, course.name, course.courseNumber, '34kb23id', course.time,
                                               course.location), "Invalid Class Number")

        self.assertEqual(Terminal.createCourse(self, course.name, course.courseNumber, course.classNumber, 'sdffw',
                                               course.location), "Invalid Time")

        self.assertEqual(Terminal.createCourse(self, course.name, course.courseNumber, course.classNumber, course.time,
                                               'eq2"kbt'), "Invalid Location")
        #Have in order error reports
        self.assertEqual(Terminal.createCourse(self, 'eiufb23]]u', 'sdfsdf', 'wefwvfwe','wergewrg',
    ...
    def test_email(self):
        ...
        self.assertTrue(user.permission[1] == '1' or user.permission[1] == '2' or user.permission[1] == '3')
        self.assertTrue(user2.permission[1] == '1' or user2.permission[1] == '2' or user2.permission[1] == '3')
        self.assertTrue(user3.permission[1] == '1' or user3.permission[1] == '2' or user3. permission[1] == '3')
        self.assertTrue((user4.permission[1] != '1' and user4.permission[1] == '2' and user4.permission[1] == '3'), "Not Authorized To Use This Command")
    ...
    def test_assignInstructorToCourse(self):
        ...
        course = Course.Course(courseData.id, courseData.name, courseData.courseNumber, courseData.classNumber,
                               courseData.time, courseData.location)
        self.user = user
        self.assertEqual(Terminal.assignInstructorToCourse(self, course.databaseID, user.databaseID), user.firstName
                         + " " + user.lastName + " was added to " + course.name)
        self.assertEqual(Terminal.assignInstructorToCourse(self, '234', user.databaseID), "Course not found")
        self.assertEqual(Terminal.assignInstructorToCourse(self, course.databaseID, '23'), "User not found")
    ...
    def test_assignAssistantToCourse(self):
        ...
        self.assertTrue((user3.permission[1] != '1'), "Not Authorized To Use This Command")
        self.assertTrue((user4.permission[1] != '1'), "Not Authorized To Use This Command")
        self.assertTrue(Terminal.assignAssistantToCourse(self, course.databaseID, user.databaseID), user.firstName
                         + " " + user.lastName + " was added to " + course.name)
        self.assertEqual(Terminal.assignInstructorToCourse(self, '234', user.databaseID), "Course not found")
        self.assertEqual(Terminal.assignInstructorToCourse(self, course.databaseID, '23'), "User not found")
    ...
    def test_viewContactInfo(self):
        ...
        self.user = user
        self.assertEqual(Terminal.viewContactInfo(self), str(user.permission) + " " + user.username + " " + user.password
                         + " " + str(user.databaseID) + " " + user.email + " " + user.firstName + " " + user.lastName + " " + user.contactPhone
                         + " " + user.officePhone + " " + user.extension)
        self.user = user2
        self.assertEqual(Terminal.viewContactInfo(self), user2.permission + " " + user2.username + " " + user2.password
                         + " " + user2.databaseID + " " + user2.email + " " + user2.firstName + " " + user2.lastName + " " + user2.contactPhone
                         + " " + user2.officePhone + " " + user2.extension)
        self.user = user3
        self.assertEqual(Terminal.viewContactInfo(self), user3.permission + " " + user3.username + " " + user3.password
